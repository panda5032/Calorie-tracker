const FoodDatabase = {
    foods: {
        ...
        // ===== More Drinks =====
        "sparkling water": { name: "Sparkling Water", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "lacroix": { name: "LaCroix Sparkling Water", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "perrier": { name: "Perrier Sparkling Water", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "topo chico": { name: "Topo Chico", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "san pellegrino": { name: "San Pellegrino Sparkling Water", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "bubly": { name: "Bubly Sparkling Water", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "flavored water": { name: "Flavored Water (Hint)", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "16 oz" },
        "vitamin water": { name: "Vitaminwater", cal: 120, protein: 0, carbs: 32, fat: 0, serving: "20 oz" },
        "vitamin water zero": { name: "Vitaminwater Zero", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "20 oz" },
        "gatorade": { name: "Gatorade", cal: 80, protein: 0, carbs: 21, fat: 0, serving: "12 oz" },
        "powerade": { name: "Powerade", cal: 80, protein: 0, carbs: 21, fat: 0, serving: "12 oz" },
        "body armor": { name: "BodyArmor Sports Drink", cal: 70, protein: 0, carbs: 18, fat: 0, serving: "12 oz" },
        "pedialyte": { name: "Pedialyte", cal: 25, protein: 0, carbs: 6, fat: 0, serving: "12 oz" },
        "kombucha": { name: "Kombucha", cal: 60, protein: 0, carbs: 14, fat: 0, serving: "12 oz" },
        "celsius": { name: "Celsius Energy Drink", cal: 10, protein: 0, carbs: 2, fat: 0, serving: "12 oz" },
        "monster energy": { name: "Monster Energy Drink", cal: 210, protein: 0, carbs: 54, fat: 0, serving: "16 oz" },
        "red bull": { name: "Red Bull", cal: 110, protein: 0, carbs: 28, fat: 0, serving: "8.4 oz" },
        "red bull sugar free": { name: "Red Bull Sugar Free", cal: 10, protein: 0, carbs: 0, fat: 0, serving: "8.4 oz" },
        "bang energy": { name: "Bang Energy Drink", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "16 oz" },
        "prime": { name: "Prime Hydration", cal: 25, protein: 0, carbs: 6, fat: 0, serving: "16 oz" },
        "prime energy": { name: "Prime Energy Drink", cal: 10, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "coca cola": { name: "Coca-Cola", cal: 140, protein: 0, carbs: 39, fat: 0, serving: "12 oz" },
        "diet coke": { name: "Diet Coke", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "coke zero": { name: "Coke Zero", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "pepsi": { name: "Pepsi", cal: 150, protein: 0, carbs: 41, fat: 0, serving: "12 oz" },
        "diet pepsi": { name: "Diet Pepsi", cal: 0, protein: 0, carbs: 0, fat: 0, serving: "12 oz" },
        "sprite": { name: "Sprite", cal: 140, protein: 0, carbs: 38, fat: 0, serving: "12 oz" },
        "dr pepper": { name: "Dr Pepper", cal: 150, protein: 0, carbs: 40, fat: 0, serving: "12 oz" },
        "mountain dew": { name: "Mountain Dew", cal: 170, protein: 0, carbs: 46, fat: 0, serving: "12 oz" },
        "fanta": { name: "Fanta Orange", cal: 160, protein: 0, carbs: 44, fat: 0, serving: "12 oz" },
        "root beer": { name: "Root Beer", cal: 152, protein: 0, carbs: 40, fat: 0, serving: "12 oz" },
        "arizona tea": { name: "Arizona Iced Tea", cal: 180, protein: 0, carbs: 48, fat: 0, serving: "16 oz" },
        "snapple": { name: "Snapple", cal: 160, protein: 0, carbs: 40, fat: 0, serving: "16 oz" },
        "simply orange": { name: "Simply Orange Juice", cal: 110, protein: 2, carbs: 26, fat: 0, serving: "8 oz" },
        "tropicana": { name: "Tropicana Orange Juice", cal: 110, protein: 2, carbs: 26, fat: 0, serving: "8 oz" },
        "naked juice": { name: "Naked Juice Green Machine", cal: 270, protein: 4, carbs: 63, fat: 0, serving: "15.2 oz" },
        "oat milk": { name: "Oat Milk", cal: 120, protein: 3, carbs: 16, fat: 5, serving: "1 cup" },
        "soy milk": { name: "Soy Milk", cal: 80, protein: 7, carbs: 4, fat: 4, serving: "1 cup" },
        "fairlife milk": { name: "Fairlife Milk", cal: 80, protein: 13, carbs: 6, fat: 2.5, serving: "1 cup" },
        "eggnog": { name: "Eggnog", cal: 224, protein: 6, carbs: 24, fat: 12, serving: "1 cup" },
        "hard seltzer": { name: "Hard Seltzer (White Claw)", cal: 100, protein: 0, carbs: 2, fat: 0, serving: "12 oz" },
        "ipa beer": { name: "IPA Beer", cal: 200, protein: 2, carbs: 15, fat: 0, serving: "12 oz" },
        "light beer": { name: "Light Beer", cal: 103, protein: 1, carbs: 6, fat: 0, serving: "12 oz" },
        "mimosa": { name: "Mimosa", cal: 150, protein: 1, carbs: 18, fat: 0, serving: "8 oz" },
        "bloody mary": { name: "Bloody Mary", cal: 120, protein: 1, carbs: 5, fat: 0, serving: "8 oz" },
        "pina colada": { name: "Pina Colada", cal: 490, protein: 1, carbs: 64, fat: 16, serving: "12 oz" },
        "long island": { name: "Long Island Iced Tea", cal: 292, protein: 0, carbs: 33, fat: 0, serving: "8 oz" },
        "mai tai": { name: "Mai Tai", cal: 260, protein: 0, carbs: 24, fat: 0, serving: "8 oz" },
        "tequila shot": { name: "Tequila Shot", cal: 97, protein: 0, carbs: 0, fat: 0, serving: "1.5 oz" },
        "rum": { name: "Rum", cal: 97, protein: 0, carbs: 0, fat: 0, serving: "1.5 oz" },
        "gin and tonic": { name: "Gin & Tonic", cal: 171, protein: 0, carbs: 14, fat: 0, serving: "8 oz" },
        "champagne": { name: "Champagne", cal: 84, protein: 0.1, carbs: 1.5, fat: 0, serving: "4 oz" },
        "sake": { name: "Sake", cal: 195, protein: 0.5, carbs: 7, fat: 0, serving: "6 oz" },
        "apple cider": { name: "Apple Cider", cal: 120, protein: 0, carbs: 28, fat: 0, serving: "8 oz" },

        // ===== More Ethnic/International =====
        "banh mi": { name: "Banh Mi Sandwich", cal: 460, protein: 22, carbs: 50, fat: 18, serving: "1 sandwich" },
        "boba tea": { name: "Boba Milk Tea", cal: 350, protein: 1, carbs: 56, fat: 14, serving: "16 oz" },
        "bubble tea": { name: "Bubble Tea", cal: 350, protein: 1, carbs: 56, fat: 14, serving: "16 oz" },
        "miso soup": { name: "Miso Soup", cal: 40, protein: 3, carbs: 4, fat: 1.5, serving: "1 cup" },
        "edamame appetizer": { name: "Edamame (appetizer)", cal: 188, protein: 18, carbs: 14, fat: 8, serving: "1 cup" },
        "tempura": { name: "Shrimp Tempura", cal: 320, protein: 16, carbs: 30, fat: 16, serving: "6 pieces" },
        "teriyaki bowl": { name: "Teriyaki Bowl", cal: 550, protein: 30, carbs: 65, fat: 14, serving: "1 bowl" },
        "poke bowl": { name: "Poke Bowl", cal: 450, protein: 28, carbs: 50, fat: 14, serving: "1 bowl" },
        "sashimi": { name: "Sashimi (assorted)", cal: 200, protein: 30, carbs: 2, fat: 8, serving: "8 pieces" },
        "california roll": { name: "California Roll", cal: 255, protein: 9, carbs: 38, fat: 7, serving: "6 pieces" },
        "spicy tuna roll": { name: "Spicy Tuna Roll", cal: 290, protein: 15, carbs: 26, fat: 11, serving: "6 pieces" },
        "dragon roll": { name: "Dragon Roll", cal: 350, protein: 12, carbs: 42, fat: 14, serving: "8 pieces" },
        "ramen tonkotsu": { name: "Tonkotsu Ramen", cal: 550, protein: 22, carbs: 60, fat: 24, serving: "1 bowl" },
        "yakisoba": { name: "Yakisoba", cal: 380, protein: 14, carbs: 52, fat: 12, serving: "1 plate" },
        "katsu curry": { name: "Chicken Katsu Curry", cal: 620, protein: 28, carbs: 70, fat: 24, serving: "1 plate" },
        "udon": { name: "Udon Noodle Soup", cal: 340, protein: 14, carbs: 56, fat: 6, serving: "1 bowl" },
        "korean bbq": { name: "Korean BBQ (bulgogi)", cal: 320, protein: 28, carbs: 12, fat: 18, serving: "1 serving" },
        "kimchi": { name: "Kimchi", cal: 23, protein: 1.3, carbs: 4, fat: 0.5, serving: "1/2 cup" },
        "fried tofu": { name: "Fried Tofu", cal: 225, protein: 14, carbs: 10, fat: 16, serving: "1 cup" },
        "butter chicken": { name: "Butter Chicken", cal: 440, protein: 28, carbs: 14, fat: 30, serving: "1 cup" },
        "samosa": { name: "Samosa", cal: 260, protein: 5, carbs: 30, fat: 14, serving: "2 pieces" },
        "palak paneer": { name: "Palak Paneer", cal: 320, protein: 14, carbs: 12, fat: 24, serving: "1 cup" },
        "biryani": { name: "Chicken Biryani", cal: 400, protein: 20, carbs: 50, fat: 14, serving: "1 cup" },
        "tandoori chicken": { name: "Tandoori Chicken", cal: 260, protein: 32, carbs: 6, fat: 12, serving: "1 leg" },
        "dal": { name: "Dal (Lentil Curry)", cal: 200, protein: 12, carbs: 30, fat: 4, serving: "1 cup" },
        "naan garlic": { name: "Garlic Naan", cal: 300, protein: 9, carbs: 48, fat: 8, serving: "1 piece" },
        "pupusa": { name: "Pupusa", cal: 230, protein: 8, carbs: 26, fat: 10, serving: "1 pupusa" },
        "empanada": { name: "Empanada", cal: 280, protein: 10, carbs: 24, fat: 16, serving: "1 empanada" },
        "arepa": { name: "Arepa", cal: 200, protein: 4, carbs: 28, fat: 8, serving: "1 arepa" },
        "plantain": { name: "Fried Plantain", cal: 250, protein: 1, carbs: 40, fat: 10, serving: "1 cup" },
        "jerk chicken": { name: "Jerk Chicken", cal: 280, protein: 30, carbs: 6, fat: 15, serving: "1 serving" },
        "oxtail": { name: "Oxtail Stew", cal: 350, protein: 28, carbs: 14, fat: 20, serving: "1 cup" },
        "rice and beans": { name: "Rice and Beans", cal: 220, protein: 8, carbs: 40, fat: 3, serving: "1 cup" },
        "carne asada": { name: "Carne Asada", cal: 290, protein: 30, carbs: 0, fat: 18, serving: "6 oz" },
        "carnitas": { name: "Carnitas", cal: 260, protein: 22, carbs: 0, fat: 18, serving: "100g" },
        "al pastor": { name: "Al Pastor Tacos", cal: 260, protein: 18, carbs: 22, fat: 12, serving: "2 tacos" },
        "birria tacos": { name: "Birria Tacos", cal: 450, protein: 28, carbs: 30, fat: 24, serving: "3 tacos" },
        "elote": { name: "Elote (Mexican Street Corn)", cal: 210, protein: 5, carbs: 28, fat: 10, serving: "1 ear" },
        "churro": { name: "Churro", cal: 230, protein: 3, carbs: 30, fat: 12, serving: "1 churro" },
        "tres leches": { name: "Tres Leches Cake", cal: 350, protein: 6, carbs: 44, fat: 16, serving: "1 slice" },
        "pita wrap": { name: "Pita Wrap (chicken)", cal: 380, protein: 24, carbs: 36, fat: 14, serving: "1 wrap" },
        "kebab": { name: "Chicken Kebab", cal: 280, protein: 28, carbs: 8, fat: 15, serving: "2 skewers" },
        "tabbouleh": { name: "Tabbouleh", cal: 120, protein: 3, carbs: 16, fat: 6, serving: "1 cup" },
        "baba ganoush": { name: "Baba Ganoush", cal: 130, protein: 3, carbs: 10, fat: 9, serving: "1/3 cup" },
        "spanakopita": { name: "Spanakopita", cal: 200, protein: 6, carbs: 14, fat: 14, serving: "1 piece" },
        "pierogi": { name: "Pierogi", cal: 300, protein: 8, carbs: 40, fat: 12, serving: "4 pierogi" },
        "bratwurst": { name: "Bratwurst", cal: 280, protein: 12, carbs: 2, fat: 25, serving: "1 link" },
        "schnitzel": { name: "Schnitzel", cal: 380, protein: 24, carbs: 20, fat: 22, serving: "1 piece" },
        "crepe": { name: "Crepe (Nutella & banana)", cal: 340, protein: 7, carbs: 48, fat: 14, serving: "1 crepe" },
        "croissant sandwich": { name: "Croissant Sandwich (ham & cheese)", cal: 420, protein: 18, carbs: 32, fat: 26, serving: "1 sandwich" },
        "poutine": { name: "Poutine", cal: 740, protein: 18, carbs: 60, fat: 46, serving: "1 serving" },
        "fish and chips": { name: "Fish and Chips", cal: 600, protein: 22, carbs: 60, fat: 28, serving: "1 serving" },
        "bangers and mash": { name: "Bangers and Mash", cal: 480, protein: 18, carbs: 40, fat: 28, serving: "1 serving" },

        // ===== More Grocery/Everyday Items =====
        "string cheese": { name: "String Cheese", cal: 80, protein: 7, carbs: 0, fat: 6, serving: "1 stick" },
        "babybel cheese": { name: "Babybel Cheese", cal: 70, protein: 5, carbs: 0, fat: 6, serving: "1 piece" },
        "cheese quesadilla": { name: "Cheese Quesadilla", cal: 350, protein: 14, carbs: 28, fat: 20, serving: "1 quesadilla" },
        "grilled chicken salad": { name: "Grilled Chicken Salad", cal: 320, protein: 30, carbs: 14, fat: 16, serving: "1 bowl" },
        "cobb salad": { name: "Cobb Salad", cal: 440, protein: 30, carbs: 12, fat: 30, serving: "1 bowl" },
        "chef salad": { name: "Chef Salad", cal: 360, protein: 22, carbs: 10, fat: 26, serving: "1 bowl" },
        "chicken caesar wrap": { name: "Chicken Caesar Wrap", cal: 420, protein: 28, carbs: 34, fat: 18, serving: "1 wrap" },
        "veggie burger": { name: "Veggie Burger", cal: 270, protein: 14, carbs: 30, fat: 10, serving: "1 burger" },
        "impossible burger": { name: "Impossible Burger", cal: 340, protein: 24, carbs: 5, fat: 26, serving: "1 patty" },
        "beyond burger": { name: "Beyond Burger", cal: 230, protein: 20, carbs: 6, fat: 14, serving: "1 patty" },
        "turkey burger": { name: "Turkey Burger", cal: 210, protein: 22, carbs: 0, fat: 13, serving: "1 patty" },
        "chicken breast grilled": { name: "Grilled Chicken Breast (plain)", cal: 165, protein: 31, carbs: 0, fat: 3.6, serving: "4 oz" },
        "rotisserie chicken leg": { name: "Rotisserie Chicken Leg", cal: 220, protein: 26, carbs: 0, fat: 12, serving: "1 leg" },
        "deli turkey": { name: "Deli Turkey Slices", cal: 60, protein: 12, carbs: 2, fat: 0.5, serving: "4 slices" },
        "deli ham": { name: "Deli Ham Slices", cal: 70, protein: 10, carbs: 2, fat: 2, serving: "4 slices" },
        "pepperoni": { name: "Pepperoni Slices", cal: 130, protein: 6, carbs: 1, fat: 11, serving: "14 slices" },
        "salami": { name: "Salami", cal: 110, protein: 7, carbs: 0, fat: 9, serving: "3 slices" },
        "spam": { name: "Spam", cal: 180, protein: 7, carbs: 1, fat: 16, serving: "2 oz" },
        "canned tuna": { name: "Canned Tuna", cal: 100, protein: 22, carbs: 0, fat: 1, serving: "1 can drained" },
        "canned chicken": { name: "Canned Chicken", cal: 130, protein: 16, carbs: 0, fat: 7, serving: "2 oz" },
        "sardines": { name: "Sardines (canned)", cal: 190, protein: 23, carbs: 0, fat: 11, serving: "1 can" },
        "tuna salad": { name: "Tuna Salad", cal: 280, protein: 24, carbs: 4, fat: 18, serving: "1/2 cup" },
        "chicken salad": { name: "Chicken Salad", cal: 320, protein: 20, carbs: 6, fat: 24, serving: "1/2 cup" },
        "egg salad": { name: "Egg Salad", cal: 280, protein: 12, carbs: 4, fat: 24, serving: "1/2 cup" },
        "deviled eggs": { name: "Deviled Eggs", cal: 126, protein: 6, carbs: 1, fat: 10, serving: "2 halves" },
        "hard boiled egg": { name: "Hard Boiled Egg", cal: 78, protein: 6, carbs: 0.6, fat: 5, serving: "1 egg" },
        "egg whites": { name: "Egg Whites", cal: 34, protein: 7, carbs: 0.5, fat: 0, serving: "2 whites" },
        "fried egg": { name: "Fried Egg", cal: 90, protein: 6, carbs: 0.4, fat: 7, serving: "1 egg" },
        "quiche": { name: "Quiche", cal: 380, protein: 14, carbs: 22, fat: 26, serving: "1 slice" },
        "frittata": { name: "Frittata", cal: 240, protein: 16, carbs: 4, fat: 18, serving: "1 slice" },
        "acai bowl": { name: "Acai Bowl", cal: 390, protein: 6, carbs: 62, fat: 12, serving: "1 bowl" },
        "overnight oats": { name: "Overnight Oats", cal: 280, protein: 10, carbs: 40, fat: 8, serving: "1 cup" },
        "smoothie bowl": { name: "Smoothie Bowl", cal: 350, protein: 8, carbs: 52, fat: 12, serving: "1 bowl" },
        "avocado toast": { name: "Avocado Toast", cal: 280, protein: 7, carbs: 26, fat: 17, serving: "1 slice" },
        "toast": { name: "Toast (with butter)", cal: 130, protein: 3, carbs: 15, fat: 6, serving: "1 slice" },
        "english muffin": { name: "English Muffin", cal: 132, protein: 5, carbs: 26, fat: 1, serving: "1 muffin" },
        "biscuit": { name: "Biscuit", cal: 180, protein: 4, carbs: 22, fat: 8, serving: "1 biscuit" },
        "cornflakes": { name: "Corn Flakes", cal: 100, protein: 2, carbs: 24, fat: 0, serving: "1 cup" },
        "cheerios": { name: "Cheerios", cal: 100, protein: 3, carbs: 20, fat: 2, serving: "1 cup" },
        "frosted flakes": { name: "Frosted Flakes", cal: 130, protein: 1, carbs: 32, fat: 0, serving: "1 cup" },
        "lucky charms": { name: "Lucky Charms", cal: 140, protein: 2, carbs: 29, fat: 1.5, serving: "1 cup" },
        "cinnamon toast crunch": { name: "Cinnamon Toast Crunch", cal: 130, protein: 1, carbs: 25, fat: 3.5, serving: "3/4 cup" },
        "fruit loops": { name: "Froot Loops", cal: 110, protein: 1, carbs: 26, fat: 1, serving: "1 cup" },
        "raisin bran": { name: "Raisin Bran", cal: 190, protein: 5, carbs: 46, fat: 1, serving: "1 cup" },
        "special k": { name: "Special K", cal: 120, protein: 7, carbs: 23, fat: 0.5, serving: "1 cup" },
        "chobani yogurt": { name: "Chobani Greek Yogurt", cal: 110, protein: 15, carbs: 11, fat: 0, serving: "1 cup" },
        "yoplait yogurt": { name: "Yoplait Yogurt", cal: 150, protein: 6, carbs: 25, fat: 2, serving: "6 oz" },
        "applesauce": { name: "Applesauce", cal: 100, protein: 0, carbs: 27, fat: 0, serving: "1 cup" },
        "fruit cup": { name: "Fruit Cup", cal: 80, protein: 0, carbs: 20, fat: 0, serving: "1 cup" },
        "pudding": { name: "Pudding Cup", cal: 130, protein: 2, carbs: 22, fat: 4, serving: "1 cup" },
        "jello": { name: "Jello", cal: 70, protein: 1, carbs: 17, fat: 0, serving: "1 cup" },
        "rice pudding": { name: "Rice Pudding", cal: 220, protein: 5, carbs: 36, fat: 6, serving: "1 cup" },
        "banana bread": { name: "Banana Bread", cal: 260, protein: 4, carbs: 38, fat: 10, serving: "1 slice" },
        "zucchini bread": { name: "Zucchini Bread", cal: 240, protein: 3, carbs: 32, fat: 12, serving: "1 slice" },
        "corn muffin": { name: "Corn Muffin", cal: 198, protein: 4, carbs: 28, fat: 8, serving: "1 muffin" },
        "scone": { name: "Scone", cal: 310, protein: 5, carbs: 40, fat: 14, serving: "1 scone" },
        "cinnamon roll": { name: "Cinnamon Roll", cal: 380, protein: 5, carbs: 52, fat: 17, serving: "1 roll" },
        "danish": { name: "Danish Pastry", cal: 260, protein: 4, carbs: 28, fat: 15, serving: "1 pastry" },
        "toaster strudel": { name: "Toaster Strudel", cal: 180, protein: 3, carbs: 26, fat: 7, serving: "1 pastry" },
        "uncrustable": { name: "Uncrustable PB&J", cal: 210, protein: 6, carbs: 26, fat: 9, serving: "1 sandwich" },
        "pb&j": { name: "Peanut Butter & Jelly Sandwich", cal: 390, protein: 14, carbs: 50, fat: 16, serving: "1 sandwich" },
        "grilled chicken wrap": { name: "Grilled Chicken Wrap", cal: 360, protein: 28, carbs: 32, fat: 12, serving: "1 wrap" },
        "buffalo wings": { name: "Buffalo Wings", cal: 380, protein: 28, carbs: 4, fat: 28, serving: "6 wings" },
        "bbq chicken": { name: "BBQ Chicken", cal: 280, protein: 30, carbs: 12, fat: 12, serving: "1 breast" },
        "chicken fried steak": { name: "Chicken Fried Steak", cal: 470, protein: 24, carbs: 26, fat: 30, serving: "1 piece" },
        "pot stickers": { name: "Pot Stickers", cal: 280, protein: 10, carbs: 32, fat: 12, serving: "6 pieces" },
        "crab rangoon": { name: "Crab Rangoon", cal: 280, protein: 7, carbs: 24, fat: 18, serving: "4 pieces" },
        "fried calamari": { name: "Fried Calamari", cal: 310, protein: 14, carbs: 22, fat: 18, serving: "1 serving" },
        "bruschetta": { name: "Bruschetta", cal: 180, protein: 4, carbs: 20, fat: 10, serving: "3 pieces" },
        "loaded baked potato": { name: "Loaded Baked Potato", cal: 450, protein: 14, carbs: 42, fat: 26, serving: "1 potato" },
        "stuffed pepper": { name: "Stuffed Bell Pepper", cal: 280, protein: 16, carbs: 24, fat: 14, serving: "1 pepper" },
        "chicken pot sticker": { name: "Chicken Pot Stickers", cal: 280, protein: 12, carbs: 30, fat: 12, serving: "6 pieces" },
        "corn on the cob": { name: "Corn on the Cob (buttered)", cal: 180, protein: 5, carbs: 32, fat: 5, serving: "1 ear" },
        "sweet potato fries": { name: "Sweet Potato Fries", cal: 300, protein: 3, carbs: 40, fat: 14, serving: "1 serving" },
        "onion rings appetizer": { name: "Onion Rings (appetizer)", cal: 480, protein: 6, carbs: 52, fat: 28, serving: "1 order" },
        "chia pudding": { name: "Chia Pudding", cal: 210, protein: 6, carbs: 24, fat: 10, serving: "1 cup" },
        "protein powder": { name: "Protein Powder (1 scoop)", cal: 120, protein: 24, carbs: 3, fat: 1, serving: "1 scoop" },
        "ensure": { name: "Ensure Nutrition Shake", cal: 220, protein: 9, carbs: 33, fat: 6, serving: "8 oz" },
        "slim fast": { name: "SlimFast Shake", cal: 180, protein: 10, carbs: 25, fat: 5, serving: "11 oz" },
    },
